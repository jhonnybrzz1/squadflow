-- Model Registry — enforce uniqueness of (alias, candidate_model_id) (PostgreSQL)
-- Up migration.
--
-- The original 0009 migration created a NON-unique index on
...
-- creating the unique index. Wrapped in a transaction for atomicity.

BEGIN;

-- Step 1: Delete duplicates, keeping the most recently inserted row.
